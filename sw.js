...
var BESTANDEN = ['./', './index.html', './les.html', './vak.html', './styles.css', './app.js',
  ...
  './ssms-inhoud.js', './governance-college-1.js', './governance-slides-1.js', './governance-college-2.js', './society-slides-1.js', './ps-college-1.js', './ps-college-2.js', './drm-conceptlist-1.js', './drm-conceptlist-2.js', './drm-conceptlist-3.js', './faw-writer-responsible.js', './society-college-2.js', './society-college-3.js', './recap-society.js', './recap-professional-skills.js', './recap-governance.js', './vakken.js', './manifest.webmanifest'];
