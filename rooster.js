...
function opFeed(fn){
  ...
  if (ROOSTER_FEED && typeof DATA !== 'undefined') fn();
}
...
/* autoVakken is verwijderd.

   Die functie maakte van elk roostermoment een 'les' en bouwde daar hele
   vakken van, met namen als 'Hoorcollege · wo 9 sep'. Dat botste steeds
   met de echte inhoud: welk bestand als laatste aan de beurt was, won.

   Het rooster hoort bij het rooster. Welke vakken er zijn en wat erin
   zit staat nu uitsluitend in vakken.js. Wat hieronder overblijft leest
   je MyTimetable-link en vertelt wanneer je waar moet zijn. */
